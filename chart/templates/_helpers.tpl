...
Service name.
*/}}
{{- define "nats-gatekeeper.serviceName" -}}
...
{{- $shortns := regexSplit "-" .Release.Namespace -1 | first }}
{{- list "" (include "nats-gatekeeper.ingressPathNamespace" .) (include "nats-gatekeeper.name" .) | join "/" }}
{{- end }}
...
*/}}
{{- define "nats-gatekeeper.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "nats-gatekeeper.fullname" .) .Values.serviceAccount.name }}
{{- else }}
